...
#include "./tool_function/console_draw3.h"
#include "./tool_function/kb_input2.h"

#include "header.h"
#include "./game_function/initial_round.h"
#include "./game_function/initial_object.h"
